...
input_csv_path = '/work/scratch/abdul/CLAM/Renal/patches_RESULTS/COMBINED_process_list_autogen_SELECTED.csv'
output_csv_path = '/work/scratch/abdul/CLAM/Renal/tumor_vs_normal_combined_clean.csv'
